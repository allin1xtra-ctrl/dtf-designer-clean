      ...
      <aside className="w-[360px] shrink-0 overflow-y-auto border-r border-[#222] bg-[#111] p-5">
        ...
        <div className="mt-5 rounded border border-[#2b2b2b] bg-[#171717] p-4">
          ...
          <div className="mt-3 rounded border border-[#2b2b2b] bg-[#111] p-3">
            ...
            <input id="design-idea-input" name="designIdeaPrompt" type="text" value={designIdeaPrompt} onChange={(e) => setDesignIdeaPrompt(e.target.value)} placeholder="e.g. vintage skull with roses and bold script" className="mb-2 w-full rounded bg-[#1f1f1f] px-2 py-2 text-sm" />
