    ...
    <div className="h-dvh max-h-dvh overflow-hidden bg-[#0e0e0e] text-white">
      ...
      <div className="customizer-mobile-shell-wrap">
        ...
        <div className="mt-5 block rounded border border-[#2b2b2b] bg-[#171717] p-4 pb-8 opacity-100">
          ...
          <main className="order-2 flex min-h-0 min-w-0 flex-1 items-center justify-center bg-[#181818] px-3 py-0 md:px-6 md:py-0">
          <div
            ref={previewPaneRef}
            className="flex h-full min-h-0 w-full max-w-full items-center justify-center overflow-hidden px-2 py-0 md:min-h-0 md:px-4 md:py-0"
